...
# Este é o aplicativo de chatbot Streamlit, "S.O.S Pets"
...
# Caminho absoluto da imagem para evitar erro de media storage
logo_path = os.path.join(os.path.dirname(__file__), "sos_pets.jpg")

st.set_page_config(
    page_title="Sos Pets", # Título na aba do navegador
    page_icon=logo_path,
    layout="wide",
    initial_sidebar_state="expanded"
)

logo_path = "sos_pets.jpg" # Mantido como estava no seu código original
...
if check_password():
    ...
    with st.sidebar:
        ...
        with col2:
            # ALTERADO AQUI: De 'DETETIVE PETS' para 'SOS PETS'
        ...
        if use_rag:
            ...
            if rag_source == "Arquivo":
                ...
                uploaded_file = st.file_uploader(f"Carregar Arquivo {file_type}", type=file_type.lower(), key="file_uploader")
